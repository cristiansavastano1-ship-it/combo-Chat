...
st.set_page_config(page_title="COMBO — Audit Model v1", page_icon="🧪", layout="centered")
...
st.caption("Versione separata per testare il modello originale senza modificarlo")

st.info("Questa app è un laboratorio separato. Il backtest audit non usa i calibratori salvati: serve a misurare il modello grezzo senza contaminare il test con una calibrazione allenata sullo storico completo.")
