...
# =====================================================================
# V7 — VALIDAZIONE STATISTICA / OOS
# Aggiunge bootstrap ROI e intervalli di incertezza ai risultati V6.
# Non modifica il modello originale.
# =====================================================================

def _v7_bootstrap_roi(df, n_boot=2000, seed=42):
    """Bootstrap a livello di scommessa per ROI/profitto.
    ROI = profitto medio per 1u stake. Restituisce IC percentile 2.5-97.5.
    """
